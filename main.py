...
number2 = ((1 + ((-0.453509101 + 3)) / procent / 100) * number1 - rata)
number3 = ((1 + ((2.324671717 + 3)) / procent / 100) * number2 - rata)
number4 = ((1 + ((1.261254407 + 3)) / procent / 100) * number3 - rata)
number5 = ((1 + ((1.782526286 + 3)) / procent / 100) * number4 - rata)
number6 = ((1 + ((2.329384541 + 3)) / procent / 100) * number5 - rata)
number7 = ((1 + ((1.502229842 + 3)) / procent / 100) * number6 - rata)
number8 = ((1 + ((1.782526286 + 3)) / procent / 100) * number7 - rata)
number9 = ((1 + ((2.328848994 + 3)) / procent / 100) * number8 - rata)
number10 = ((1 + ((0.616921348 + 3)) / procent / 100) * number9 - rata)
number11 = ((1 + ((2.352295886 + 3)) / procent / 100) * number10 - rata)
number12 = ((1 + ((0.337779545 + 3)) / procent / 100) * number11 - rata)
number13 = ((1 + ((1.577035247 + 3)) / procent / 100) * number12 - rata)
number14 = ((1 + ((-0.292781443 + 3)) / procent / 100) * number13 - rata)
number15 = ((1 + ((2.48619659 + 3)) / procent / 100) * number14 - rata)
number16 = ((1 + ((0.267110318 + 3)) / procent / 100) * number15 - rata)
number17 = ((1 + ((1.417952672 + 3)) / procent / 100) * number16 - rata)
number18 = ((1 + ((1.054243267 + 3)) / procent / 100) * number17 - rata)
number19 = ((1 + ((1.480520104 + 3)) / procent / 100) * number18 - rata)
number20 = ((1 + ((1.577035247 + 3)) / procent / 100) * number19 - rata)
number21 = ((1 + ((-0.07742069 + 3)) / procent / 100) * number20 - rata)
number22 = ((1 + ((1.165733399 + 3)) / procent / 100) * number21 - rata)
number23 = ((1 + ((-0.404186718 + 3)) / procent / 100) * number22 - rata)
number24 = ((1 + ((1.499708521 + 3)) / procent / 100) * number23 - rata)
